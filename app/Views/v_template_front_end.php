...
<head>
  ...
  <title>WEB KAB CIREBON - <?= $judul ?></title>
...
<body>
  ...
  <header id="header" class="fixed-top">
    ...
    <img src="<?= base_url('logo/logo.png') ?>" width="60px">

      <h1 class="logo me-auto"><a href="index.html">KABUPATEN CIREBON</a></h1>
      <!-- Uncomment below if you prefer to use an image logo -->
      <!-- <a href="index.html" class="logo me-auto"><img src="<?= base_url('front-end') ?>/assets/img/logo.png" alt="" class="img-fluid"></a>-->

      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          <li><a class="active" href="index.html">Home</a></li>
          <li><a href="pricing.html">Sejarah Desa</a></a></li>
